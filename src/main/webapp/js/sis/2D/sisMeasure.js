            ...
            if (self.isMeasureTooltip) {
                ...
                // if (self.clickIdx > 1) {
                    ...
                    if (self.type === "LineString") {
                        if(self.clickIdx == 1) {
                            self.overlayElement.firstElementChild.innerHTML = "시작점";
                            self.overlayLayer.setPosition(self.measureFeature.getGeometry().getCoordinates()[0]);

                            self.overlayLayer = null;
                            self._createMeasureTooltip();
                        }
                        else if (self.clickIdx > 1) {
