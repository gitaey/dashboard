(function (window, $) {
    ...
    SisMap.prototype = {
        ...
        props: {
            ...
            minZoom: 0,
            zoom: 3,
            center: [14086766.472503208, 4364628.511630771] //지도 센터 좌표
        },
        ...
        getBaseMap: function (id) {
            ...
            if (id.toLowerCase() == "vworld") {
                baseMap = {
                    ...
                    projection: "EPSG:3857",
                    tileSize: 256,
                    center: [14099913.641368203, 4373285.0050840555],
                    extent: [14098021.61, 4170799.78, 14140057.41, 4199108.25],
                    resolutions: [1222.99245256282, 611.49622628141, 305.748113140705, 152.8740565703525, 76.43702828517625, 38.21851414258813, 19.109257071294063, 9.554628535647032, 4.777314267823516, 2.388657133911758, 1.194328566955879, 0.5971642834779395, 0.29858214173896974],
                };
